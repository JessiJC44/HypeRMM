...
export function Sidebar({ activeTab, setActiveTab, isOpen, onClose, user }: SidebarProps) {
  ...
  const menuItems = [
    { id: 'dashboard', label: t('nav.dashboard'), icon: LayoutDashboard, description: t('nav.desc_dashboard') },
    { id: 'rmm', label: 'RMM', icon: Activity, description: t('nav.desc_rmm') },
    { id: 'agent-download', label: t('nav.agent_download'), icon: Download, description: t('nav.desc_agent_download') },
    { id: 'tickets', label: t('nav.tickets'), icon: Ticket, description: t('nav.desc_tickets') },
    ...
    { id: 'network', label: t('nav.network'), icon: Search, description: t('nav.desc_network') },
    { id: 'snmp', label: t('nav.snmp'), icon: Activity, description: t('nav.desc_snmp') },
    { id: 'kb', label: t('nav.kb'), icon: BookOpen, description: t('nav.desc_kb') },
    { id: 'reports', label: t('nav.reports'), icon: BarChart3, description: t('nav.desc_reports') },
    { id: 'refer', label: t('nav.refer'), icon: Gift, description: t('nav.desc_refer') },
    { id: 'ai-center', label: t('nav.ai-center'), icon: Sparkles, description: t('nav.desc_ai_center') },
    { id: 'admin', label: t('nav.admin'), icon: Lock, description: t('nav.desc_admin') },
  ];
