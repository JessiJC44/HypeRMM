...
const AppleIcon = ({ size = 16, className = "" }: { size?: number; className?: string }) => (
  <svg 
    ...
    className={className}
  >
    <path d="M17.05 20.28c-.98.95-2.05 1.61-3.19 1.61-1.18 0-1.55-.7-3.03-.7s-1.91.7-3.03.7c-1.14 0-2.26-.71-3.23-1.66C2.6 18.33 1.5 15.11 1.5 12.03c0-3.14 2.03-4.81 3.99-4.81 1.04 0 2.01.39 2.64.39.61 0 1.76-.46 2.97-.46 1.56 0 2.7.61 3.44 1.52-3.15 1.84-2.64 5.76.08 6.96-.73 1.83-1.72 3.75-3.07 4.65zM12.03 7.25c-.08-2.23 1.84-4.13 3.97-4.25.21 2.44-2.11 4.41-3.97 4.25z"/>
  </svg>
);
